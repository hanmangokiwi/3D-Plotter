...
setblock -15 110 -50 minecraft:pink_terracotta
execute as @a at @s run playsound minecraft:block.anvil.land master @s ~ ~ ~ 1 1.5

fill 50 0 50 -50 0 -50 air
fill 50 0 0 -50 0 0 minecraft:redstone_block
...
scoreboard players set range info 0
