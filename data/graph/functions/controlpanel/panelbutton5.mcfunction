...
setblock -17 110 -50 minecraft:pink_terracotta
execute as @a at @s run playsound minecraft:block.anvil.land master @s ~ ~ ~ 1 0.5

fill 50 0 50 -50 0 -50 minecraft:redstone_block
...
scoreboard players set range info 2
